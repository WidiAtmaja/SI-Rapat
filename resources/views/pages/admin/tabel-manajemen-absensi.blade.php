        ...
        <div class="max-w-full mx-auto sm:px-4 lg:px-4">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex p-7 justify-between items-center">
                    <h1 class="text-xl font-semibold">Kegiatan Persandian</h1>
                        ...
                        <table class="min-w-full text-xs text-gray-600 border border-gray-200">
                            <thead class="bg-gray-100 text-gray-500 text-sm">
                                <tr>
                                    ...
                                    <th class="w-20 px-2 py-3 border border-gray-200 text-center">Keterangan</th>
                                </tr>
                            </thead>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-2 py-3 border border-gray-100 text-center">Hadir</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
