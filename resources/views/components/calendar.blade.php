 ...
 <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-50 max-h-svh">
     <div class="flex justify-between items-center mb-3">
         <h1 class="text-xl font-semibold">Kalender Rapat</h1>
     </div>
     <section class="relative ">
         <div class="w-full max-w-7xl mx-full">
             <div class="flex  items-center justify-between gap-3 mb-5">
                 <div class="flex items-center gap-4">
                     <h5 class="text-l leading-8 font-semibold text-gray-900">January 2024</h5>
                     <div class="flex items-center gap-2">
                         <button
                             ...
                             <svg class="pointer-events-none" xmlns="http://www.w3.org/2000/svg" width="16"
             ...
             <div class="border border-gray-200">
                 ...
                 <div class="grid grid-cols-7 divide-gray-200">
                     ...
                     <div
                         ...
                         <span class="hidden lg:block text-xs font-medium text-gray-500">Meeting
                             with marketing department</span>
                     ...
                     <div
                         ...
                         <span class="hidden lg:block text-xs font-medium text-gray-500">Developer
                             Meetup</span>
                         <span class="lg:hidden w-2 h-2 rounded-full bg-gray-400"></span>
                     </div>
                     <div
                     ...
                     <div
                         ...
                         <span class="hidden lg:block text-xs font-medium text-gray-500">Meet with
                             friends <br> 9PM</span>
                         <span class="lg:hidden w-2 h-2 rounded-full bg-gray-400"></span>
                     </div>
                 ...
                 <div class="bg-gray-50 w-full rounded-xl">
                     <div class="p-3 w-full flex items-center justify-between group transition-all duration-300">
                         <div class="flex flex-col gap-2">
                             <span class="text-sm font-medium text-gray-900">Meet with
                                 friends</span>
